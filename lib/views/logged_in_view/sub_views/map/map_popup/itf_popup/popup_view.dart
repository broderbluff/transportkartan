...
import 'package:transportkartan/views/logged_in_view/sub_views/map/map_popup/transport_popup/widgets/loading_widget.dart';
...
class ITFPopup extends StatefulWidget {
  final Marker marker;
  final List<Site> listOfMarker;

  const ITFPopup(this.marker, this.listOfMarker, {super.key});

  @override
  State<ITFPopup> createState() => _ITFPopupState();
}

class _ITFPopupState extends State<ITFPopup> {
