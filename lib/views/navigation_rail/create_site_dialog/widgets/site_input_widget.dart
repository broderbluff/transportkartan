          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<CreateSiteCubit>().addCompany('sadsds');
                  },
                ...
                ListView.builder(
                  shrinkWrap: true,
                  itemCount: siteMarkerState.companies.length,
                  itemBuilder: (context, index) {
                    final company = siteMarkerState.companies[index];
                    ...
                    return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            context.read<CreateSiteCubit>().removeCompany(company);
                          },
                        ));
                  },
                ),
